...
export interface ProjectDetail {
  ...
  /**
   * Dedicated 1200×630 social card (Open Graph / Twitter). Generated by
   * `npm run gen-detail-assets` and committed to `public/og/`. Optional — when
   * absent, the page falls back to the site-wide `og.jpg`.
   */
  ogImage?: {
    src: string;
    width: number;
